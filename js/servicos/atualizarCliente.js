...
function atualizarCliente(clientes) {
    ...
    if (atualizarTelefones.toLowerCase() === 's') {
        ...
        while (adicionarMais) {
            ...
            cliente.telefones.push(new telefone_1.default(ddd, numero));
    ...
    if (atualizarDependentes.toLowerCase() === 's') {
        ...
        while (adicionarMais) {
            ...
            cliente.dependentes.push(new cliente_1.default(nomeDependente, nomeSocialDependente, dataNascimentoDependente, enderecoDependente));
